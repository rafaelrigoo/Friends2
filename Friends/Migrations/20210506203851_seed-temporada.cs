...
namespace Friends.Migrations
{
    public partial class seedtemporada : Migration
    {
        ...
        {
            migrationBuilder.InsertData("Temporadas", new string[] { "Numero", "CaminhoImagem", "QuandoFoiLancada", "QuandoTerminou" }, new object[] { 1, "/imagens/temporada1.jpg", new DateTime(1994, 09, 22), new DateTime(1995, 05, 15) });
